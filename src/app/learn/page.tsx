...
function ProgressVisualization() {
  return (
    <>
      ...
      <Suspense fallback={null}><BrainModel /></Suspense>
...
export default function LearnPage() {
  ...
  return (
    <div className="min-h-screen pt-12 pb-12 container mx-auto px-4 space-y-12">
      {/* --- REPLACE THE OLD HEADER --- */}
      <PageHeader 
        title="Your Learning Dashboard"
        subtitle="Welcome back! Here is your personalized progress hub."
      />
